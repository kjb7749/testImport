...
namespace OpenDentBusiness {
	public class Procedures {
		...
		///come before this one in a list such as TP or claim.
		...
		///is to hold all claim procs for reference. This list will not be modified.  Only sent from PatPlans.Delete, otherwise it's set to claimProcs.</param></summary>
